...
public class PruebaProcesoInterruptus extends Thread{
    
     public static void main(String[] args) {
        Thread hilo1 =new ProcesoInterruptus("Interruptus 1");
        Thread hilo2 =new ProcesoInterruptus("ProcesoInterruptus 2");
